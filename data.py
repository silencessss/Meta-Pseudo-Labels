...
def get_AcneECK(args):
    ...
    base_dataset = datasets.ImageFolder(
        root=r'F:/DataSet/DataSet_Acne/AcneECK/Group_Order_to_Class/')
    ...
    train_unlabeled_dataset = datasets.ImageFolder(
        root=r'F:/DataSet/DataSet_Acne/Unlabel_Dataset_002/done/',
